...
- You must be a member in the <i>League of Heroes</i> in order to join this raid. You can become a member of the league by totally mastering Quest 1 including the Boss Elite (i.e. green check on the folder in Schoology).
+[...]
- Make plans with the Jedi master to prepare if you need it, and determine when & where any Boss Elites might spawn again.
+ [...]
...
<i>Words from Master Yoda: Do or do not, there is no try.</i>

-> DONE

= backstory
<b>Insula Marsupialia</b>
Your party ventures from the ship’s cabin onto the deck of the ship. A band of eight pirates, err crewman the Captain insists, have offered to join you ashore for your protection against indigenous animals. Initially this strikes you as odd. However, it seems the captain suspects you are not searching for animals, and instead looking for previously hidden treasure. You shrug your shoulders with indifference and the party heads to shore
+ [...]
- You travel inland a no more than a half mile before coming to a strange landform. Up ahead you see a perfect circle of desert pavement cover the path which looks fairly benign...except for the numerous bones scattered around the edges. You decide that one person should check out the path first while the others provide cover. The rogue would be the natural choice to send ahead on a scouting task such as this.
+ [...]
- The rogue complains loudly, “Why do I always get the raw end of the deal?” 
+ [...]
- The fighter chimes in, “You always get the raw end of the deal? What about six weeks when we encountered those stone trolls?” He continues mockingly, “Oh looks like something needs to get beaten down or hacked up - let’s send in the fighter! I’m always getting the raw end of the deal.”
+ [...]
- The wizard clears his throat, “At least you all get to wear armor. When I’m exhausted, I’ve nothing protecting my skin. I’m the one really getting the raw end of the deal”
+ [...]
- “What?!” The entire party blurts out together
+ [...]
- The cleric continues, “Need I remind you that you can shoot fireballs and summon lightning. I have to my ask my deity for help.” He quickly adds, “Not that I’m complaining. I’ve always been treated very fairly.”
+ A pirate interrupts, <>
